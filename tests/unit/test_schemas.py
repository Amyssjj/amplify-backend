...
class TestEnhancementSchemas:
    ...
    def test_enhancement_request_valid(self, sample_enhancement_request):
        ...
        # Add 'type' field for new discriminated union
        sample_enhancement_request['type'] = 'photo'
        request = PhotoEnhancementRequest(**sample_enhancement_request)
    ...
    def test_enhancement_request_validation_errors(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            PhotoEnhancementRequest(type='photo')
